...
Requires:   python3-rfc3986 >= 0.2.2
...
%changelog
# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/oslo.config/commit/?id=4848dfece9167cc310897d03df0263de4853572c
